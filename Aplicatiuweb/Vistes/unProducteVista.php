    ...
    <div class="row gx-5">
      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <a href="#" class="btn btn-light border border-secondary py-2 icon-hover px-3"> <i class="me-1 fa fa-heart fa-lg"></i> Añadir favoritos </a>
        </div>
      </main>
    </div>
  </div>
...
<section class="bg-light border-top px-4" style = "margin-bottom: 3%;">
  <div class="row-lg-4">
    <div class="px-0 border rounded-2 shadow-0">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Altres productes</h5>
